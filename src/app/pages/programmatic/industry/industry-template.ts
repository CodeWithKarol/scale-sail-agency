...
} from '../../../shared/domain/content/content.service';
  ...
  template: `
    @if (pageData(); as data) {
      <div class="min-h-screen bg-secondary pt-24 pb-12">
            ...
            >
              @for (point of data.painPoints; track point) {
                <app-card class="bg-white/5 p-8" [interactive]="true">
                  <dt class="text-base font-semibold leading-7 text-white">🛑 Risk Factor</dt>
        ...
        <section class="py-20">
          <app-section-header title="Common Questions" subtitle="FAQ" />
...
export class IndustryTemplate {
  ...
  private updateSeo(data: ProgrammaticPageData): void {
