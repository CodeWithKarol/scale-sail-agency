  ...
  steps = signal<ProcessStep[]>([
    {
      ...
      description: 'Review architecture and set clear scope.',
      iconPath: 'M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z',
    },
    {
      number: '02',
      title: 'Execution',
      description: 'Structured sprints, regular updates, no surprises.',
      iconPath:
    ...
    },
    {
      ...
      description: 'Full docs, deployment guides, team training.',
      iconPath:
