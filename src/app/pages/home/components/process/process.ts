  ...
  steps = signal<ProcessStep[]>([
    {
      ...
      description: 'Review architecture, identify bottlenecks, and define the critical path.',
    ...
    },
    {
      ...
      title: 'Execution',
      subtitle: 'PROCESSING',
      description: 'Structured sprints with bi-weekly deployments and continuous integration.',
      iconPath:
