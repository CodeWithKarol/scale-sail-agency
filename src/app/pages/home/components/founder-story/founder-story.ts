...
export class FounderStory {
  ...
  founder = signal({
    ...
    bio: [
      ...
      'Swoje doświadczenie zdobywałem projektując systemy dla największych instytucji finansowych, takich jak <strong class="font-black text-secondary">Citi czy BNP Paribas</strong>. Tam nauczyłem się, że system musi być pancerny i niezawodny. Dziś tę samą jakość i eksperckie podejście oferuję mniejszym firmom.',
