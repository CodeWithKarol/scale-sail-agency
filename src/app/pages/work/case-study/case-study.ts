        ...
        <main class="layout-container relative z-10 pt-32 sm:pt-40">
          ...
          <div class="relative z-10 mb-40 animate-in fade-in zoom-in-95 duration-1000">
            ...
            >
              ...
              />
              <div
                class="absolute bottom-10 right-10 px-6 py-3 bg-secondary text-white font-mono text-[10px] font-black uppercase tracking-[0.3em]"
              >
          ...
          <div class="mb-40">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
              ...
              <div class="lg:col-span-7 space-y-32">
                <section>
                  <div class="flex items-center gap-6 mb-12">
                    <h2
                      class="font-mono text-[10px] font-black uppercase tracking-[0.4em] text-primary"
                    >
                      01. WYZWANIE
                    </h2>
                    <div class="h-px flex-1 bg-secondary/10"></div>
                  </div>
                  <p class="text-2xl text-secondary/80 leading-relaxed font-medium">
                    {{ study.challenge }}
                  </p>
                </section>
              ...
              <div class="lg:col-span-5 lg:sticky lg:top-32">
                ...
                >
                  <h3
                    class="font-mono text-[10px] font-black uppercase tracking-[0.4em] text-primary mb-12 pb-6 border-b-2 border-secondary/5"
                  >
                    KLUCZOWE EFEKTY
                  </h3>
                  <ul class="space-y-10">
                    @for (result of study.results; track result) {
                      <li class="flex gap-6 items-start group">
                        ...
                        ></span>
                        <span class="text-lg text-secondary/80 leading-relaxed font-bold">{{
                          result
                        }}</span>
                      </li>
                    }
                  ...
                  <div class="mt-16 pt-12 border-t-2 border-secondary/5">
                    <p
                      class="font-mono text-[10px] font-black text-secondary/30 uppercase tracking-[0.3em] mb-8"
                    >
                    ...
                    <div class="flex flex-wrap gap-3">
                      @for (tech of study.techStack; track tech) {
                        <span
                          class="px-4 py-2 bg-neutral border-2 border-secondary/10 text-[10px] text-secondary/60 font-mono font-bold uppercase tracking-wider"
                          >{{ tech }}</span
                        >
                      }
                    </div>
          ...
          <section class="py-40">
            ...
            >
              <h2
                class="font-mono text-[10px] font-black uppercase tracking-[0.4em] text-primary mb-12"
              >
                CO JEST W ŚRODKU?
              </h2>
              <p class="text-2xl text-secondary/80 leading-relaxed font-medium italic">
                {{
              ...
              >
                ...
                <div
                  class="font-mono text-[10px] font-black text-secondary/40 bg-neutral px-5 py-2 border-2 border-secondary/10 uppercase tracking-widest"
                >
