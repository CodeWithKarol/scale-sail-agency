      ...
      <div class="flex flex-col p-8 h-full w-full">
        <div class="flex items-center gap-x-4 mb-6">
          ...
          <time
            ...
            class="font-mono text-[9px] font-black text-secondary/40 uppercase tracking-[0.2em]"
          >
        ...
        <p
          class="mt-6 flex-auto line-clamp-3 text-sm leading-relaxed text-secondary/70 font-medium border-l-4 border-secondary/10 pl-5 group-hover:border-primary/30 transition-colors"
        >
          {{ post().excerpt }}
        </p>
        ...
        <div class="mt-10 flex items-center pt-6 w-full border-t-2 border-secondary/5">
          <div
            class="group/link inline-flex items-center gap-3 font-mono text-[10px] font-black uppercase tracking-[0.2em] text-secondary/40 group-hover:text-primary transition-colors"
          >
            CZYTAJ ARTYKUŁ
            <span
